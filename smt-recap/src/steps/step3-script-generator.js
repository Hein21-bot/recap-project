...
function buildVideoPrompt(durationSeconds, toneKey = "knowledge", speedMultiplier = 1.0) {
  ...
  return `
သင်သည် မြန်မာဘာသာဖြင့် ဗီဒီယို Voiceover Script ရေးသားသူ ကျွမ်းကျင်သူတစ်ဦးဖြစ်သည်။

ပေးထားသော Video Transcript တစ်ခုလုံးကို မူရင်းအဓိပ္ပာယ်မပျက်ဘဲ မြန်မာဘာသာသို့ အပြည့်အဝ ဘာသာပြန်ဆို၍ အောက်ပါ လိုအပ်ချက်များအတိုင်း Script ဖန်တီးပေးပါ:
...
**လိုအပ်ချက်များ:**
1. ပေးထားသော Transcript ပါ အကြောင်းအရာများ အားလုံးကို ချန်လှပ်ထားခြင်း မရှိဘဲ အပြည့်အဝ ဘာသာပြန်ပေးရမည်။
2. မြန်မာစာလုံးရေ ${minWords} မှ ${maxWords} အတွင်းသာ ရှိရမည် (အသံဖတ်နှုန်း ${speedMultiplier}x ကိုထည့်တွက်ပြီး ဗီဒီယိုအချိန်နှင့် ကိုက်ညီစေရမည်)။
3. သတ်မှတ်ထားသော Tone နှင့်အညီ Storytelling စတိုင်ဖြင့် စနစ်တကျ ရေးသားရမည်။
4. ဗီဒီယိုအချိန် ${durationLabel} အတွင်း ကွက်တိဖြစ်စေရန် Timestamp များ ခွဲခြားထည့်သွင်းပေးရမည်။
5. မြန်မာနားဆင်သူများ လွယ်ကူစွာ နားလည်ပြီး စိတ်ဝင်စားဖွယ်ဖြစ်အောင် သဘာဝကျသော မြန်မာစကားပြောဟန်ဖြင့် ရေးသားရမည်။
...
**လိုအပ်ချက်များ:**
1. ပေးထားသော Transcript ပါ အကြောင်းအရာများ **အားလုံးကို** ချန်လှပ်ထားခြင်း၊ အနှစ်ချုပ်ခြင်း (summarize/condense) **လုံးဝ မပြုလုပ်ဘဲ** အပြည့်အဝ ဘာသာပြန်ပေးရမည်။ Transcript ထဲက စာကြောင်းတိုင်း၊ အချက်တိုင်း ပါဝင်ရမည်။
2. မြန်မာစာလုံးအရေအတွက် (space မပါ) ခန့်မှန်းခြေ ${minChars} မှ ${maxChars} ဝန်းကျင် ရှိနိုင်သည် (ဗီဒီယို ${durationLabel} အချိန်နှင့် ခန့်မှန်းအားဖြင့် ကိုက်ညီအောင်) — ဒါပေမဲ့ content အပြည့်အစုံ ပါဝင်ဖို့က ပိုအရေးကြီးတယ်၊ ဒီ range ကိုက်အောင်ဆိုပြီး content ဘယ်လိုမှ ချန်ထား/ဖြတ်တောက်ခြင်း မပြုလုပ်ပါနှင့်။
3. Natural Flow: စာဖတ်သလို မဟုတ်ဘဲ လူတစ်ယောက်က စိတ်ဝင်တစား ပြန်ပြောပြနေသလို ရေးပါ။
4. Transcript ထဲက အချက်အလက် တစ်ခုမှ ချန်မထားပါနှင့် — အားလုံး အစအဆုံး ဘာသာပြန်ပါ။
5. အထက်ဖော်ပြပါ Tone ကို သုံးပြီး ရေးပါ။
6. Timestamp ပါ ထည့်ပေးပါ။
7. မြန်မာလူမျိုးတွေနားလည်ပြီး သဘာဝကျတဲ့ စကားပြောဟန်နဲ့ ဘာသာပြန်ပေးပါ
